...
const storage = new Storage({
    projectId: 'lambelambe-406e2',
    keyFilename: 'lambelambe-406e2-firebase-adminsdk-nrs6n-7302a15daa.json'
})
...
exports.uploadImage = functions.https.onRequest((request, response) => {
    cors(request, response, () => {
        try {
            ...
            const bucket = storage.bucket('lambelambe-406e2.appspot.com')
            const id = uuid()
